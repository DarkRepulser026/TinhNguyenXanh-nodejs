  ...
  const organizationData = [
    {
      ...
      taxCode: '0312345678',
      foundedDate: new Date('2018-04-22T00:00:00.000Z'),
      legalRepresentative: 'Nguyen Thi Lan',
      documentType: 'Giay phep hoat dong',
      verificationDocsUrl: 'https://example.com/docs/tinhnguyenxanh-license.pdf',
      facebookUrl: 'https://facebook.com/tinhnguyenxanhcommunity',
      zaloNumber: '0908123456',
      achievements: 'To chuc hon 150 su kien tinh nguyen va thu hut tren 8,000 luot tham gia trong 5 nam.',
      focusAreas: ['Environment', 'Education', 'Community Support'],
      avatarUrl: 'https://api.dicebear.com/7.x/icons/svg?seed=tinhnguyenxanh',
      memberCount: 64,
      eventsOrganized: 52,
    },
    {
      ...
      organizationType: 'Non-profit',
      taxCode: '0108765432',
      foundedDate: new Date('2016-09-15T00:00:00.000Z'),
      legalRepresentative: 'Tran Minh Duc',
      documentType: 'Giay dang ky hoat dong giao duc',
      verificationDocsUrl: 'https://example.com/docs/educationforall-registration.pdf',
      facebookUrl: 'https://facebook.com/educationforall.vn',
      zaloNumber: '0911222333',
      achievements: 'Trien khai 90 lop bo tro va trao 2,300 suat hoc bong cho hoc sinh kho khan.',
      focusAreas: ['Education', 'Tech', 'Community Support'],
      avatarUrl: 'https://api.dicebear.com/7.x/icons/svg?seed=education',
      memberCount: 49,
      eventsOrganized: 38,
    },
    {
      ...
      taxCode: '0409988776',
      foundedDate: new Date('2019-01-10T00:00:00.000Z'),
      legalRepresentative: 'Le Quoc Bao',
      documentType: 'Giay phep to chuc phi chinh phu',
      verificationDocsUrl: 'https://example.com/docs/healthfoundation-ngo-license.pdf',
      facebookUrl: 'https://facebook.com/healthwellnessfoundation.vn',
      zaloNumber: '0933555777',
      achievements: 'Dong hanh cung 20 tram y te dia phuong, to chuc 70 dot kham suc khoe cong dong mien phi.',
      focusAreas: ['Healthcare', 'Community Support'],
      avatarUrl: 'https://api.dicebear.com/7.x/icons/svg?seed=health',
      memberCount: 57,
      eventsOrganized: 44,
    },
  ];
    ...
    const org = await models.organization.findOneAndUpdate(
      { ownerUserId: orgData.owner._id },
      {
        $set: {
          ...
          documentType: orgData.documentType,
          verificationDocsUrl: orgData.verificationDocsUrl,
          ...
          eventsOrganized: orgData.eventsOrganized,
          verified: true,
        },
        $setOnInsert: {
          ownerUserId: orgData.owner._id,
